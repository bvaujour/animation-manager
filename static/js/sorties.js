(function () {
    ...
    form.addEventListener("submit", async (event) => {
        ...
        const payload = {
            ...
            destination_adresse: String(form.elements.destination_adresse.value || "").trim(),
            destination_code_postal: String(form.elements.destination_code_postal.value || "").trim(),
            destination_commune: String(form.elements.destination_commune.value || "").trim(),
            destination_code_insee: String(form.elements.destination_code_insee.value || "").trim(),
