...
from .access import (
    connexion_requise_page, direction_requise, direction_requise_api,
    disponibilites_personnelles_api, lecture_partagee_api,
)
from .views import (
    accueil, administration, api_affectation_create, api_affectation_detail,
    api_animateur_detail, api_animateurs, api_centre_detail, api_centres,
    api_centres_reordonner, api_disponibilite_detail, api_disponibilites,
    api_document_detail, api_documents, api_groupe_detail, api_groupes,
    api_groupes_reordonner, api_periode_scolaire_detail, api_periodes_scolaires,
    api_periodes_scolaires_importer, api_periodes_scolaires_previsualiser,
    api_planning, api_planning_auto, api_planning_plage, api_qualification_detail,
    api_qualifications, api_recapitulatif, api_tableau_de_bord, changer_mot_de_passe,
    documents, emails, employe_detail, employes, export_planning_excel,
    export_planning_pdf, gestion, mes_disponibilites, planning, recapitulatif,
)
from .views_communications import (
    api_contact_email_detail, api_contacts_email, api_emails_animateur,
    api_envois_email, api_modele_email_detail, api_modeles_email,
)
from .views_effectifs import api_effectifs_enfants_groupe
