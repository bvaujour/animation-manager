...
from animateurs.models import Animateur, Centre, Disponibilite, HoraireAffectationJour
...
class AffectationServiceTests(TestCase):
    ...
    def test_les_horaires_appartiennent_a_lanimateur_et_au_jour(self):
        affectation = creer_affectation(
            animateur=self.animateur,
            centre=self.centre_a,
            debut=self.jour,
        ...
        horaire = HoraireAffectationJour.objects.create(
        ...
        self.assertEqual(horaire.affectation.animateur, self.animateur)
        self.assertEqual(horaire.date, self.jour.date())
